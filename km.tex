...
\begin{figure}[H]
\centering
\subfloat[IR controler to IR resiver distance vs erorr]{\includegraphics[width=0.5\textwidth]{Experimental.png}}  \subfloat[IR controler to IR resiver distance vs erorr]{\includegraphics[width=0.5\textwidth]{ir2.png}}\\
